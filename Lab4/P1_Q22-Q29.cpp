...
void Q22_printList(cDouList* list) {
    printList(list);
}

void Q23_addHead(cDouList* list, int data) {
    addHead(list, data);
}

void Q24_addTail(cDouList* list, int data) {
    addTail(list, data);
}

void Q25_addAt(cDouList* list, int k, int data) {
    addAt(list, k-1, data);
}

void Q26_deleteHead(cDouList* list) {
    deleteHead(list);
}

void Q27_deleteAt(cDouList* list, int k) {
    deleteAt(list, k-1);
}

void Q28_deleteTail(cDouList* list) {
    deleteTail(list);
}

void Q29_indexOf(cDouList* list, int data) {
    if (getLength(list) == 0){
        cout << "List is empty. \n";
        return;
    }
